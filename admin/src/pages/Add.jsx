    ...
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3">
      ...
      <div>
        ...
        <div className="flex gap-3">
          ...
          >
            <p
              className={`px-3 py-1 cursor-pointer ${sizes.includes("XXL") ? "bg-black text-white" : "bg-slate-200"
                }`}
            >
              XXL
            </p>
      ...
      <button className={`cursor-pointer ${clickable? "":"pointer-events-none"} w-28 py-3 mt-4 bg-black text-white`}  type="submit">
        ADD
      </button>
    </form>
  );
